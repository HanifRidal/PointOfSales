...
using PintOfSales_DBfirst.Models;

namespace PintOfSales_DBfirst.Controllers
{
    public class ProductsController : Controller
    {
        private readonly PointOfSalesContext _context;

        public ProductsController(PointOfSalesContext context)
        {
            _context = context;
        }
        ...
        {
            var pointOfSalesContext = _context.Products.Include(p => p.Category);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PointOfSalesContext.Products'  is null.");
            }
            var product = await _context.Products.FindAsync(id);
            if (product != null)
            {
